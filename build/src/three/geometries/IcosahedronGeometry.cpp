...
namespace three {
	...
	IcosahedronBufferGeometry::IcosahedronBufferGeometry(float radius, float detail):PolyhedronBufferGeometry(icosahedron_geometry::vertices, icosahedron_geometry::indices, radius, detail)
	{		
	}
